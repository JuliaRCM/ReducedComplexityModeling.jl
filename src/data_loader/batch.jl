...
This is, among others, used to train neural networks of [`GeometricMachineLearning.NeuralNetworkIntegrator`](@extref) type (as opposed to [`GeometricMachineLearning.TransformerIntegrator`](@extref)).
"""
...
This is used to train neural networks of [`GeometricMachineLearning.TransformerIntegrator`](@extref) type.
...
function batch_over_two_axes(batch::Batch, number_columns::Int, third_dim::Int, dl::DataLoader)
    time_indices = Random.shuffle(1:number_columns)
    parameter_indices = Random.shuffle(1:third_dim)
